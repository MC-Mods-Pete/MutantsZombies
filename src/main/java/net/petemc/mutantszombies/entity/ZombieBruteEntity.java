...
public class ZombieBruteEntity extends HostileEntity {
    ...
    public void playStepSound(@NotNull BlockPos pos, @NotNull BlockState blockIn) {
        this.playSound(Registries.SOUND_EVENT.get(new Identifier("block.rooted_dirt.step")), 0.15F, 1.0F);
    }
    ...
    public SoundEvent getDeathSound() {
        return Registries.SOUND_EVENT.get(new Identifier("entity.zombie.death"));
    }
