...
public class CrawlerEntity extends HostileEntity {
    ...
    public static void init() {
        ...
        BiomeModifications.addSpawn(BiomeSelectors.all(),
                SpawnGroup.MONSTER, ModEntities.CRAWLER, 5, 1, 3);
    }

    public static DefaultAttributeContainer.Builder createHordeZombieAttributes() {
        return HostileEntity.createHostileAttributes()
                .add(EntityAttributes.GENERIC_MAX_HEALTH, 6.0)       // default 20.0
                ...
                .add(EntityAttributes.GENERIC_ATTACK_DAMAGE, 3.0)     // default 3.0
                .add(EntityAttributes.GENERIC_ARMOR, 0.0)             // default 2.0
