...
public class SpitterEntity extends Monster implements RangedAttackMob {
    ...
    public SoundEvent getAmbientSound() {
        return (SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.parse("entity.player.burp"));
    }

    public void playStepSound(@NotNull BlockPos blockPos, @NotNull BlockState blockState) {
        this.playSound((SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.parse("block.basalt.step")), 0.15F, 1.0F);
    }
