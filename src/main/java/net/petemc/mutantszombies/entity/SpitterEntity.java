...
public class SpitterEntity extends HostileEntity implements RangedAttackMob {
    ...
    public SoundEvent getAmbientSound() {
        return Registries.SOUND_EVENT.get(new Identifier("entity.player.burp"));
    }

    public void playStepSound(@NotNull BlockPos pos, @NotNull BlockState blockIn) {
        this.playSound(Registries.SOUND_EVENT.get(new Identifier("block.basalt.step")), 0.15F, 1.0F);
    }
