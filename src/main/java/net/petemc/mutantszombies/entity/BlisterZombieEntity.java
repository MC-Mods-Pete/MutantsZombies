...
public class BlisterZombieEntity extends EntityMob {
    public BlisterZombieEntity(World world) {
        super(world);
    ...
    protected void initEntityAI() {
        ...
        this.targetTasks.addTask(1, new EntityAIHurtByTarget(this, true, BlisterZombieEntity.class));
