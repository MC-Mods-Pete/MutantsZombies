...
public class RegisterEntityAttributes {
    ...
    public static class ForgeEvents {
        ...
        public static void registerAttributes(EntityAttributeCreationEvent event) {
            ...
            event.put(ModEntities.CRAWLER_ZOMBIE.get(), CrawlerEntity.createAttributes().build());
            event.put(ModEntities.SPITTER_ZOMBIE.get(), SpitterEntity.createAttributes().build());
