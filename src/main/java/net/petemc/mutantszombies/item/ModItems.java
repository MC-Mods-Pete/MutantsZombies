...
public class ModItems {
    ...
    public static final Item SPLIT_HEAD_ZOMBIE_SPAWN_EGG = registerItem("split_head_zombie_spawn_egg", new SpawnEggItem(ModEntities.SPLIT_HEAD_ZOMBIE, -10063432, -13428768, (new FabricItemSettings())));
    public static final Item MUTANT_BRUTE_SPAWN_EGG = registerItem("mutant_brute_spawn_egg", new SpawnEggItem(ModEntities.MUTANT_BRUTE, -10063452, -13448768, (new FabricItemSettings())));
    public static final Item ROTTEN_MUTANT_SPAWN_EGG = registerItem("rotten_mutant_spawn_egg", new SpawnEggItem(ModEntities.ROTTEN_MUTANT, -10042452, -13244638, (new FabricItemSettings())));
