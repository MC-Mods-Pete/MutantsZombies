...
public class ModItems {
    ...
    static {
        ...
        CRAWLER_SPAWN_EGG = REGISTRY.register("crawler_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.CRAWLER, -10027264, -6684775, (new Item.Properties())));
        ...
        SPITTER_SPAWN_EGG = REGISTRY.register("spitter_spawn_egg", () -> new ForgeSpawnEggItem(ModEntities.SPITTER, -10066432, -13408768, (new Item.Properties())));
    }
}
