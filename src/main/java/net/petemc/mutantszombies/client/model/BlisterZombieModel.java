...
public class BlisterZombieModel extends EntityModel<BlisterZombieEntityRenderState> {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(Identifier.of(MutantsZombies.MOD_ID, "blister_zombie_layer"), "main");
    ...
    public static TexturedModelData createBodyLayer() {
        ...
        ModelPartData head = modelPartData.addChild("head", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -6.0F, -9.0F));
        ...
        ModelPartData faceplates = head.addChild("faceplates", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -1.0F, -6.0F));
        ...
        ModelPartData sidegrips = head.addChild("sidegrips", ModelPartBuilder.create().uv(0, 72).cuboid(5.0F, -1.0F, -5.0F, 0.5F, 1.0F, 10.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, -4.0F));
        ...
        ModelPartData backplates = torso.addChild("backplates", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -7.0F, -1.0F));
        ...
        ModelPartData left_arm = modelPartData.addChild("left_arm", ModelPartBuilder.create(), ModelTransform.origin(6.0F, -4.0F, -6.0F));
        ...
        ModelPartData right_arm = modelPartData.addChild("right_arm", ModelPartBuilder.create(), ModelTransform.origin(-6.0F, -4.0F, -5.0F));
        ...
        ModelPartData left_leg = modelPartData.addChild("left_leg", ModelPartBuilder.create().uv(19, 38).cuboid(0.0F, 6.0F, -8.0F, 2.0F, 6.0F, 3.0F, new Dilation(0.0F)), ModelTransform.origin(2.0F, 12.0F, 1.0F));
        ...
        ModelPartData right_leg = modelPartData.addChild("right_leg", ModelPartBuilder.create(), ModelTransform.origin(-3.0F, 12.0F, 1.0F));
    ...
    @Override
    public void setAngles(BlisterZombieEntityRenderState renderState) {
