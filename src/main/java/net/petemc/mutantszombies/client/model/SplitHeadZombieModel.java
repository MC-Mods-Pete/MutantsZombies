...
public class SplitHeadZombieModel<T extends Entity> extends EntityModel<T> {
    ...
    public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        head1.render(matrices, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
        head2.render(matrices, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
