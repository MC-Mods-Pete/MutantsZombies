...
public class RottenMutantModel<T extends RottenMutantEntity> extends EntityModel<T> {
	public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier(MutantsZombies.MOD_ID, "rotten_mutant_layer"), "main");
    ...
    public static TexturedModelData createBodyLayer() {
        ...
        ModelPartData metalrods = torso.addChild("metalrods", ModelPartBuilder.create().uv(35, 27).cuboid(4.0F, 1.25F, -5.0F, 0.5F, 1.0F, 23.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -10.0F, -14.0F));
        ...
        ModelPartData left_arm = modelPartData.addChild("left_arm", ModelPartBuilder.create(), ModelTransform.pivot(6.0F, -7.0F, -3.0F));
        ...
        ModelPartData right_arm = modelPartData.addChild("right_arm", ModelPartBuilder.create(), ModelTransform.pivot(-6.0F, -7.0F, -3.0F));
        ...
        ModelPartData left_leg = modelPartData.addChild("left_leg", ModelPartBuilder.create().uv(17, 38).cuboid(-2.075F, 14.0F, -4.0F, 4.0F, 6.0F, 3.0F, new Dilation(0.25F)), ModelTransform.pivot(3.0F, 4.0F, 0.0F));
        ...
        ModelPartData right_leg = modelPartData.addChild("right_leg", ModelPartBuilder.create(), ModelTransform.pivot(-3.0F, 3.0F, 0.0F));
    ...
    public void setAngles(T entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        this.left_arm.pitch = MathHelper.cos(limbAngle * 0.5F + (float)Math.PI) * limbDistance;
