...
public class CrawlerModel<T extends Entity> extends EntityModel<T> {
    ...
    public static TexturedModelData createBodyLayer() {
        ...
        ModelPartData head = modelPartData.addChild("head", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 15.0F, -4.0F));
        ...
        ModelPartData teeth = head.addChild("teeth", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 1.0F, -1.0F));
        ModelPartData bottomteeth = teeth.addChild("bottomteeth", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ...
        ModelPartData topteeth = teeth.addChild("topteeth", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ...
        ModelPartData rightcheek = head.addChild("rightcheek", ModelPartBuilder.create(), ModelTransform.pivot(-3.0F, 3.0F, -4.0F));
        ...
        ModelPartData leftcheek = head.addChild("leftcheek", ModelPartBuilder.create(), ModelTransform.pivot(3.0F, 3.0F, -4.0F));
        ...
        ModelPartData tounge = head.addChild("tounge", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 2.0F, -8.0F));
        ...
        ModelPartData torso = modelPartData.addChild("torso", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 19.0F, 2.0F));
        ...
        ModelPartData left_arm = modelPartData.addChild("left_arm", ModelPartBuilder.create(), ModelTransform.pivot(4.0F, 16.0F, -3.0F));
        ...
        ModelPartData right_arm = modelPartData.addChild("right_arm", ModelPartBuilder.create(), ModelTransform.pivot(-4.0F, 16.0F, -3.0F));
        ...
        ModelPartData left_leg = modelPartData.addChild("left_leg", ModelPartBuilder.create(), ModelTransform.pivot(4.0F, 17.0F, 10.0F));
        ...
        ModelPartData right_leg = modelPartData.addChild("right_leg", ModelPartBuilder.create(), ModelTransform.pivot(-4.0F, 17.0F, 9.0F));
    ...
    public void setAngles(T entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        this.right_arm.pitch = MathHelper.cos(limbAngle * 1.0F) * 1.0F * limbDistance;
        this.left_leg.pitch = MathHelper.cos(limbAngle * 1.0F) * -1.0F * limbDistance;
        this.left_arm.pitch = MathHelper.cos(limbAngle * 1.0F) * -1.0F * limbDistance;
