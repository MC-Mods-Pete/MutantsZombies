...
public class SpitterModel extends EntityModel<SpitterEntityRenderState> {
    ...
    public static TexturedModelData createBodyLayer() {
        ...
        ModelPartData head2 = modelPartData.addChild("head2", ModelPartBuilder.create(), ModelTransform.origin(-13.0F, 7.0F, -8.0F));
        ...
        ModelPartData head3 = modelPartData.addChild("head3", ModelPartBuilder.create(), ModelTransform.origin(-1.0F, 3.0F, -10.0F));
        ...
        ModelPartData head4 = modelPartData.addChild("head4", ModelPartBuilder.create(), ModelTransform.origin(0.0F, -6.0F, 4.0F));
        ...
        ModelPartData head5 = modelPartData.addChild("head5", ModelPartBuilder.create(), ModelTransform.origin(12.0F, 10.0F, -6.0F));
        ...
        ModelPartData head7 = modelPartData.addChild("head7", ModelPartBuilder.create(), ModelTransform.origin(-10.0F, -4.0F, 11.0F));
        ...
        ModelPartData head8 = modelPartData.addChild("head8", ModelPartBuilder.create(), ModelTransform.origin(-8.0F, 11.0F, 8.0F));
        ...
        ModelPartData torso = modelPartData.addChild("torso", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 5.0F, 0.0F));
        ...
        ModelPartData left_leg = modelPartData.addChild("left_leg", ModelPartBuilder.create(), ModelTransform.origin(10.0F, 16.0F, 0.0F));
        ...
        ModelPartData right_leg = modelPartData.addChild("right_leg", ModelPartBuilder.create(), ModelTransform.origin(-10.0F, 16.0F, 0.0F));
    ...
    @Override
    public void setAngles(SpitterEntityRenderState renderState) {
        this.head8.yaw = renderState.relativeHeadYaw / (180F / (float)Math.PI);
        this.head8.pitch = renderState.pitch / (180F / (float)Math.PI);
        ...
        this.head3.yaw = renderState.relativeHeadYaw / (180F / (float)Math.PI);
        this.head3.pitch = renderState.pitch / (180F / (float)Math.PI);
        this.head4.yaw = renderState.relativeHeadYaw / (180F / (float)Math.PI);
        this.head4.pitch = renderState.pitch / (180F / (float)Math.PI);
        this.head5.yaw = renderState.relativeHeadYaw / (180F / (float)Math.PI);
        this.head5.pitch = renderState.pitch / (180F / (float)Math.PI);
        this.head6.yaw = renderState.relativeHeadYaw / (180F / (float)Math.PI);
        this.head6.pitch = renderState.pitch / (180F / (float)Math.PI);
        this.head7.yaw = renderState.relativeHeadYaw / (180F / (float)Math.PI);
        this.head7.pitch = renderState.pitch / (180F / (float)Math.PI);
    }
}
