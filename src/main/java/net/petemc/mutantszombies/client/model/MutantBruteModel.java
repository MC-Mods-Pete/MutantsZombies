...
public class MutantBruteModel<T extends MutantBruteEntity> extends EntityModel<T> {
	...
	public static TexturedModelData createBodyLayer() {
		...
		ModelPartData head = modelPartData.addChild("head", ModelPartBuilder.create(), ModelTransform.pivot(1.0F, -23.0F, -26.0F));
		...
		ModelPartData blisterhead = head.addChild("blisterhead", ModelPartBuilder.create(), ModelTransform.pivot(-1.0F, 39.0F, 26.0F));
		...
		ModelPartData Minihead = head.addChild("Minihead", ModelPartBuilder.create().uv(150, 25).cuboid(-5.0F, -8.0F, -15.0F, 8.0F, 9.0F, 16.0F, new Dilation(0.0F))
				.uv(40, 7).cuboid(-4.0F, 1.0F, -14.0F, 2.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(-10.0F, 4.0F, 2.0F));
		...
		ModelPartData torso = modelPartData.addChild("torso", ModelPartBuilder.create().uv(79, 84).cuboid(-16.0F, -49.0F, -15.0F, 13.0F, 21.0F, 37.0F, new Dilation(0.0F))
				...
				.uv(0, 71).cuboid(-13.0F, -38.0F, 4.0F, 25.0F, 17.0F, 33.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, -13.0F));
		...
		ModelPartData blistertorso = torso.addChild("blistertorso", ModelPartBuilder.create().uv(142, 84).cuboid(10.0F, -40.0F, 21.0F, 12.0F, 10.0F, 13.0F, new Dilation(0.0F))
				...
				.uv(90, 0).cuboid(20.0F, -32.0F, 19.0F, 3.0F, 4.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -8.0F, 0.0F));
		...
		ModelPartData bone = blistertorso.addChild("bone", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
		...
		ModelPartData right_arm = modelPartData.addChild("right_arm", ModelPartBuilder.create(), ModelTransform.pivot(-16.0F, -17.0F, -19.0F));
		...
		ModelPartData left_arm2 = right_arm.addChild("left_arm2", ModelPartBuilder.create(), ModelTransform.pivot(-7.0F, 6.0F, -3.0F));
		...
		ModelPartData blisterarm = right_arm.addChild("blisterarm", ModelPartBuilder.create(), ModelTransform.pivot(16.0F, -2.0F, -3.0F));
		...
		ModelPartData left_arm = modelPartData.addChild("left_arm", ModelPartBuilder.create(), ModelTransform.pivot(20.0F, -17.0F, -15.0F));
		...
		ModelPartData left_leg = modelPartData.addChild("left_leg", ModelPartBuilder.create().uv(70, 173).cuboid(-5.0F, 22.0F, 1.0F, 9.0F, 3.0F, 9.0F, new Dilation(0.0F)), ModelTransform.pivot(12.0F, -1.0F, 20.0F));
		...
		ModelPartData blisterleg = left_leg.addChild("blisterleg", ModelPartBuilder.create().uv(170, 153).cuboid(8.0F, -1.0F, 0.0F, 8.0F, 9.0F, 9.0F, new Dilation(0.0F))
				...
				.uv(104, 142).cuboid(10.0F, 5.0F, -2.0F, 8.0F, 6.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(-8.0F, 14.0F, 1.0F));
		...
		ModelPartData right_leg = modelPartData.addChild("right_leg", ModelPartBuilder.create().uv(172, 50).cuboid(-4.0F, 24.0F, -6.0F, 8.0F, 2.0F, 10.0F, new Dilation(0.0F)), ModelTransform.pivot(-13.0F, -1.0F, 20.0F));
    ...
    public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        head.render(matrices, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
        torso.render(matrices, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
        right_arm.render(matrices, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
        left_arm.render(matrices, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
        left_leg.render(matrices, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
        right_leg.render(matrices, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
    }
