...
public class MutantBruteModel<T extends MutantBruteEntity> extends EntityModel<T> {
    ...
    public void render(MatrixStack matrices, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        head.render(matrices, vertexConsumer, packedLight, packedOverlay, color);
        torso.render(matrices, vertexConsumer, packedLight, packedOverlay, color);
        right_arm.render(matrices, vertexConsumer, packedLight, packedOverlay, color);
        left_arm.render(matrices, vertexConsumer, packedLight, packedOverlay, color);
