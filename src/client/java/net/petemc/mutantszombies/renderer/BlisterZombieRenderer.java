...
import net.petemc.mutantszombies.model.BlisterZombieModel;
...
public class BlisterZombieRenderer extends MobRenderer<BlisterZombieEntity, BlisterZombieEntityRenderState, BlisterZombieModel> {
    ...
    public @NotNull Identifier getTextureLocation(@NotNull BlisterZombieEntityRenderState blisterZombieEntityRenderState) {
